public class KscapeCombos {
    ...
    public static String[] WATER = {
            "Born Ruler", "Pure-Hearted Android", "Hinomotoan Chef", "Mechanized Blacksmith", "Dragon Guardian",
            "Mizutsune Archer", "Artistry's Pinnacle", "Princess Starfall", "The Blue Rose"
    };

    public static String[] WIND = {
            "Bondforged Scion", "The Black Raven", "Eternal Partner", "Lovestruck Maid", "Rebellious Commander",
            "Twilight Hunter", "Child of the Forest", "Bridge Builder", "Resolved Hunter"
    };

    public static String[] LIGHT = {
            "Ambitious Knight", "Harmony Seeker", "Budding Artist", "The Paternal King", "The Wing of Enlightenment",
            "Beach Belle", "Radiant Auspex", "Unwavering Auspex", "Mischievous Android"
    };

    public static String[] SHADOW = {
            "Liberated Assassin", "Leader of the Boar Clan", "Tutelary Successor", "Festive Commander", "Naginata Cutie",
            "Enchanting Aromatherapist", "Supreme Sorcerer", "Wistful Widow", "Embracing Shadow"
    };

    public static String[][] KSCAPE_LABELS = {FLAME, WATER, WIND, LIGHT, SHADOW};
